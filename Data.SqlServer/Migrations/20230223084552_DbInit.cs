    ...
    public partial class DbInit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 2, 23, 15, 45, 52, 333, DateTimeKind.Local).AddTicks(9413), "", "Trang chủ", "/#", null, 0, 0, true },
                    { 2, new DateTime(2023, 2, 23, 15, 45, 52, 333, DateTimeKind.Local).AddTicks(9415), "", "Giới thiệu", "/gioi-thieu", null, 0, 0, true },
                    { 3, new DateTime(2023, 2, 23, 15, 45, 52, 333, DateTimeKind.Local).AddTicks(9417), "", "Trang 3", "/trang3", null, 0, 0, true },
                    { 4, new DateTime(2023, 2, 23, 15, 45, 52, 333, DateTimeKind.Local).AddTicks(9418), "", "Trang 34", "/trang4", null, 0, 3, true },
                    { 5, new DateTime(2023, 2, 23, 15, 45, 52, 333, DateTimeKind.Local).AddTicks(9419), "", "Trang 35", "/trang5", null, 0, 3, true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 2, 23, 15, 45, 52, 333, DateTimeKind.Local).AddTicks(9274), "", new DateTime(2023, 2, 23, 15, 45, 52, 333, DateTimeKind.Local).AddTicks(9274), "a.png", "Sự kiện 11", null, 0, true },
                    { 2, new DateTime(2023, 2, 23, 15, 45, 52, 333, DateTimeKind.Local).AddTicks(9278), "", new DateTime(2023, 2, 23, 15, 45, 52, 333, DateTimeKind.Local).AddTicks(9277), "a.png", "Sự kiện 12", null, 0, true },
                    { 3, new DateTime(2023, 2, 23, 15, 45, 52, 333, DateTimeKind.Local).AddTicks(9280), "", new DateTime(2023, 2, 23, 15, 45, 52, 333, DateTimeKind.Local).AddTicks(9280), "a.png", "Sự kiện 13", null, 0, true },
                    { 4, new DateTime(2023, 2, 23, 15, 45, 52, 333, DateTimeKind.Local).AddTicks(9282), "", new DateTime(2023, 2, 23, 15, 45, 52, 333, DateTimeKind.Local).AddTicks(9282), "a.png", "Sự kiện 14", null, 0, true },
                    { 5, new DateTime(2023, 2, 23, 15, 45, 52, 333, DateTimeKind.Local).AddTicks(9284), "", new DateTime(2023, 2, 23, 15, 45, 52, 333, DateTimeKind.Local).AddTicks(9284), "a.png", "Sự kiện 15", null, 0, true },
                    { 6, new DateTime(2023, 2, 23, 15, 45, 52, 333, DateTimeKind.Local).AddTicks(9286), "", new DateTime(2023, 2, 23, 15, 45, 52, 333, DateTimeKind.Local).AddTicks(9286), "a.png", "Sự kiện 16", null, 0, true }
                });
